	...
	private JButton getBtnObrisiKurs() {
		if (btnObrisiKurs == null) {
			...
			btnObrisiKurs.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					GUIKontroler.prikaziObrisiKursGUI(table.getSelectedRow(), (MenjacnicaTableModel) table.getModel());
				}
			});
	...
	private JButton getBtnIzvrsiZamenu() {
		if (btnIzvrsiZamenu == null) {
			...
			btnIzvrsiZamenu.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					GUIKontroler.prikaziIzvrsiZamenuGUI(table.getSelectedRow(), (MenjacnicaTableModel) table.getModel());
				}
			});
	...
	private JMenuItem getMntmNew() {
		if (mntmNew == null) {
			...
			mntmNew.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					GUIKontroler.ucitajIzFajla((MenjacnicaTableModel) table.getModel());
				}
			});
