...
public class IzvrsiZamenuGUI extends JFrame {
	...
	public IzvrsiZamenuGUI(MenjacnicaGUI glavniProzor, Valuta valuta) {
		...
		this.valuta = valuta;
		GUIKontroler.prikaziValutu(textFieldProdajniKurs, textFieldKupovniKurs, textFieldValuta, this.valuta);
	}
		...
		if (btnIzvrsiZamenu == null) {
			...
			btnIzvrsiZamenu.addActionListener(new ActionListener() {
				public void actionPerformed(ActionEvent e) {
					GUIKontroler.izvrsiZamenu(valuta, rdbtnProdaja.isSelected(), textFieldIznos, textFieldKonacniIznos);
				}
			});
